...
private_dns_resolver_forwarding_rules = {
  "privatelink.blob.core.windows.net" = {
    ...
    target_dns_servers = {
      private_dns_resolver_inbound_endpoints = {
        private_dns_resolver_ampls_eastasia_inbound1 = {
          lz_key          = "private_dns_zones_global_eastasia"
  ...
  "scadvisorcontentpl.privatelink.blob.core.windows.net" = {
    ...
    target_dns_servers = {
      private_dns_resolver_inbound_endpoints = {
        private_dns_resolver_ampls_eastasia_inbound1 = {
          lz_key          = "private_dns_resolver_ampls_eastasia"
          key             = "inbound_endpoint"
          interface_index = 0
          port            = 53
        }
  ...
  "eastasia-0.in.ai.privatelink.monitor.azure.com" = {
    name        = "eastasia-0.in.ai.privatelink.monitor.azure.com"
    domain_name = "eastasia-0.in.ai.privatelink.monitor.azure.com."
    enabled     = true
    global_settings = {
      passthrough = true
    }
  ...
  "eastasia.livediagnostics.privatelink.monitor.azure.com" = {
    name        = "eastasia.livediagnostics.privatelink.monitor.azure.com"
    domain_name = "eastasia.livediagnostics.privatelink.monitor.azure.com."
    enabled     = true
    global_settings = {
      passthrough = true
    }
